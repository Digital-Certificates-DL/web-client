...
.app-button {
  ...
  &--filled {
    ...
    --app-button-filled-text: var(--text-secondary-invert-dark);
  ...
  &--info {
    ...
    --app-button-filled-text: var(--text-primary-invert-light);
    --app-button-filled-bg-hover: var(--info-light);
    --app-button-filled-bg-active: var(--info-light);
  }
